...
LLVM_ABI void initializeYkStackmapsPass(PassRegistry&);
LLVM_ABI void initializeYkSplitBlocksAfterCallsPass(PassRegistry&);
LLVM_ABI void initializeYkBasicBlockTracerPass(PassRegistry&);
LLVM_ABI void initializeYkShadowStackPass(PassRegistry&);
LLVM_ABI void initializeYkConditionalPromoteCallsPass(PassRegistry&);
LLVM_ABI void initializeYkModuleClonePass(PassRegistry&);
LLVM_ABI void initializeFixStackmapsSpillReloadsPass(PassRegistry&);
